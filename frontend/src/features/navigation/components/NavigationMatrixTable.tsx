...
export function NavigationMatrixTable() {
  ...
  const onInspect = useActionTelemetry('navigation.component.inspect', 'navigation');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('navigation.dynamic'), cell: ({ row }) => row.name },
