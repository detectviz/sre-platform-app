...
export function MailProviderTable() {
  ...
  const onInspect = useActionTelemetry('platform.mail.component.inspect', 'platform.mail');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('page.platformMail.title'), cell: ({ row }) => row.name },
