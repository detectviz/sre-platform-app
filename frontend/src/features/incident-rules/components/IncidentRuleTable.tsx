...
export function IncidentRuleTable() {
  ...
  const onInspect = useActionTelemetry('incident.rules.component.inspect', 'incident.rules');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('page.incident.rules.alert.title'), cell: ({ row }) => row.name },
