...
export function IAMDirectoryTable() {
  ...
  const onInspect = useActionTelemetry('identity.access.management.component.inspect', 'identity.access.management');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('page.iam.personnel.title'), cell: ({ row }) => row.name },
