...
import { ResourceOverviewScene } from '../../../scenes/resources/ResourceOverviewScene';


export function ResourceTopologyPage() {
  const theme = useTheme2();
  const { t } = useI18n();
  usePageInstrumentation('resources.topology');
  ...
  return (
    <Page>
      <PageHeader title={t('page.resources.topology.title')} description={t('page.resources.topology.description')}>
        <PageToolbar>
