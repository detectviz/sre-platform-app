...
export function AutoDiscoveryPage() {
  ...
  const { t } = useI18n();
  usePageInstrumentation('resources.discovery');
  ...
  return (
    <Page>
      <PageHeader title={t('page.resources.discovery.title')} description={t('page.resources.discovery.description')}>
        <PageToolbar>
      ...
      <Page.Contents>
        ...
        >
          ...
          <EmptyState title={t('page.resources.discovery.title')} description={t('page.resources.discovery.description')} />
