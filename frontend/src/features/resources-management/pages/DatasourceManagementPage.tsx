...
export function DatasourceManagementPage() {
  ...
  const { t } = useI18n();
  usePageInstrumentation('resources.datasources');
  ...
  return (
    <Page>
      <PageHeader title={t('page.resources.datasource.title')} description={t('page.resources.datasource.description')}>
        <PageToolbar>
      ...
      <Page.Contents>
        ...
        >
          ...
          <EmptyState title={t('page.resources.datasource.title')} description={t('page.resources.datasource.description')} />
