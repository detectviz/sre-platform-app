...
export function ResourceInventoryTable() {
  ...
  const onInspect = useActionTelemetry('resources.management.component.inspect', 'resources.management');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('page.resources.list.title'), cell: ({ row }) => row.name },
