...
export function AutomationPlaybookTable() {
  ...
  const onInspect = useActionTelemetry('automation.management.component.inspect', 'automation.management');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('page.automation.playbooks.title'), cell: ({ row }) => row.name },
