...
export function AutomationTriggersPage() {
  ...
  const { t } = useI18n();
  usePageInstrumentation('automation.triggers');
  ...
  return (
    <Page>
      <PageHeader title={t('page.automation.triggers.title')} description={t('page.automation.triggers.description')}>
        <PageToolbar>
      ...
      <Page.Contents>
        ...
        >
          ...
          <EmptyState title={t('page.automation.triggers.title')} description={t('page.automation.triggers.description')} />
