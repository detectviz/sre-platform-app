...
export function NotificationChannelPage() {
  ...
  const { t } = useI18n();
  usePageInstrumentation('notifications.channels');
  ...
  return (
    <Page>
      <PageHeader title={t('page.notification.channel.title')} description={t('page.notification.channel.description')}>
        <PageToolbar>
      ...
      <Page.Contents>
        ...
        >
          ...
          <EmptyState title={t('page.notification.channel.title')} description={t('page.notification.channel.description')} />
