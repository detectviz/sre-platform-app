...
export function NotificationChannelTable() {
  ...
  const onInspect = useActionTelemetry('notification.management.component.inspect', 'notification.management');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('page.notification.strategy.title'), cell: ({ row }) => row.name },
