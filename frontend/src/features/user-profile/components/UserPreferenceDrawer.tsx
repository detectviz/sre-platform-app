...
export function UserPreferenceDrawer() {
  ...
  const onInspect = useActionTelemetry('user.profile.component.inspect', 'user.profile');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('page.userProfile.title'), cell: ({ row }) => row.name },
