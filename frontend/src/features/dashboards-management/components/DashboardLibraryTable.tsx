...
export function DashboardLibraryTable() {
  ...
  const onInspect = useActionTelemetry('dashboards.management.component.inspect', 'dashboards.management');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('page.dashboards.list.title'), cell: ({ row }) => row.name },
