...
export function SREWarRoomPage() {
  ...
  const { t } = useI18n();
  usePageInstrumentation('dashboards.warroom');
  ...
  return (
    <Page>
      <PageHeader title={t('page.dashboards.warroom.title')} description={t('page.dashboards.warroom.description')}>
        <PageToolbar>
      ...
      <Page.Contents>
        ...
        >
          ...
          <EmptyState title={t('page.dashboards.warroom.title')} description={t('page.dashboards.warroom.description')} />
