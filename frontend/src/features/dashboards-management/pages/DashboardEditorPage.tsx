...
export function DashboardEditorPage() {
  ...
  const { t } = useI18n();
  usePageInstrumentation('dashboards.editor');
  ...
  return (
    <Page>
      <PageHeader title={t('page.dashboards.editor.title')} description={t('page.dashboards.editor.description')}>
        <PageToolbar>
      ...
      <Page.Contents>
        ...
        >
          ...
          <EmptyState title={t('page.dashboards.editor.title')} description={t('page.dashboards.editor.description')} />
