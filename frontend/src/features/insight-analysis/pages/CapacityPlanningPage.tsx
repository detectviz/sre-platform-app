...
export function CapacityPlanningPage() {
  ...
  const { t } = useI18n();
  usePageInstrumentation('insight.capacity');
  ...
  return (
    <Page>
      <PageHeader title={t('page.insight.analysis.capacity.title')} description={t('page.insight.analysis.capacity.description')}>
        <PageToolbar>
      ...
      <Page.Contents>
        ...
        >
          ...
          <EmptyState title={t('page.insight.analysis.capacity.title')} description={t('page.insight.analysis.capacity.description')} />
