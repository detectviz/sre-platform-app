...
export function InsightScenarioDrawer() {
  ...
  const onInspect = useActionTelemetry('insight.analysis.component.inspect', 'insight.analysis');
  ...
  return (
    ...
    >
      <Table
        data={rows}
        columns={{
          name: { header: t('page.insight.analysis.backtesting.title'), cell: ({ row }) => row.name },
