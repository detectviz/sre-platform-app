...
const PAGE_CONTENT = {
    ...
    GLOBAL: {
        ...
        MESSAGES: {
            ...
            GENERIC_FETCH_ERROR: '目前無法載入資料。',
            GENERIC_SAVE_ERROR: '無法儲存變更。',
            GENERIC_UPDATE_ERROR: '無法更新變更。',
            GENERIC_DELETE_ERROR: '無法刪除項目。',
            GENERIC_BATCH_ACTION_ERROR: '無法完成所選操作。',
        },
        ACTION_LABELS: {
            REFRESH: '重新整理',
        },
    ...
    GENERATE_PLAYBOOK_WITH_AI_MODAL: {
        ...
        SCRIPT_TYPE_HELPER: '選擇生成的腳本類型，影響語法和執行方式。',
        CONTENT_LABEL: '腳本內容',
        PARAMETERS_LABEL: '偵測到的參數',
        RESULT_PREVIEW_HINT: '預覽生成的腳本內容和參數。',
        RESULT_PREVIEW_DESCRIPTION: '您可以編輯腳本內容或調整參數設定。',
    ...
    DASHBOARD_LIST: {
        ...
        FETCH_ERROR: '無法載入儀表板。',
        SAVE_ERROR: '無法儲存儀表板。',
        DELETE_ERROR: '無法刪除儀表板。',
        UPDATE_ERROR: '無法更新儀表板。',
        BATCH_DELETE_ERROR: '無法刪除所選儀表板。',
        COLUMN_CONFIG_SAVE_SUCCESS: '欄位設定已儲存。',
        COLUMN_CONFIG_SAVE_ERROR: '無法儲存欄位設定。',
        COLUMN_CONFIG_MISSING_ERROR: '無法儲存欄位設定：找不到頁面設定。',
        EXPORT: {
            FILENAME_PREFIX: 'dashboards',
            HEADERS: ['id', 'name', 'type', 'category', 'description', 'owner', 'updated_at', 'path'],
        },
        IMPORT: {
            ITEM_NAME: '儀表板',
            TEMPLATE_FILENAME: 'dashboards-template.csv',
            TEMPLATE_HEADERS: ['id', 'name', 'type', 'category', 'description', 'owner'],
        },
        TYPE_METADATA: {
            'built-in': {
                LABEL: '內建儀表板',
    ...
    DASHBOARD_EDITOR: {
        ...
        ADD_WIDGET_MODAL_SEARCH_LABEL: '搜尋小工具',
        ADD_WIDGET_MODAL_SEARCH_PLACEHOLDER: '輸入小工具名稱或類型...',
        ADD_WIDGET_MODAL_FILTER_LABEL: '篩選類型',
        ADD_WIDGET_MODAL_HINT: '選擇您要新增至儀表板的小工具類型。',
        ADD_WIDGET_EMPTY_STATE: '沒有找到符合條件的小工具。',
        ADD_WIDGET_TITLE: '新增',
    ...
    SILENCE_RULE_EDIT_MODAL: {
        ...
        BASIC_INFO: {
            APPLY_TEMPLATE: '快速套用範本',
            TEMPLATE_DESCRIPTION: '從現有範本快速建立規則，節省設定時間。',
            NAME: '規則名稱 *',
            NAME_DESCRIPTION: '用於識別此靜音規則的名稱，建議簡潔明瞭。',
            DESCRIPTION: '描述',
            DESCRIPTION_HELP: '補充規則的目的與適用場景，協助其他成員快速理解。',
        },
        SCHEDULE: {
            TYPE: '排程類型',
            TYPE_HINT: '選擇靜音規則的執行方式：單次或週期性重複。',
            SINGLE: '單次靜音',
            RECURRING: '週期性靜音',
            START_TIME: '開始時間',
            START_TIME_HINT: '設定靜音規則生效的開始時間。',
            END_TIME: '結束時間',
            END_TIME_HINT: '設定靜音規則結束的時間。',
            FREQUENCY: '重複頻率',
            FREQUENCY_HINT: '設定靜音規則重複執行的頻率。',
            EXECUTION_TIME: '執行時間',
            EXECUTION_TIME_HINT: '設定靜音規則在一天中的執行時間。',
            SELECT_WEEKDAYS: '選擇星期',
            WEEKDAYS: ['日', '一', '二', '三', '四', '五', '六'],
            CRON_EXPRESSION: 'Cron 表達式',
            CRON_HINT: '使用 Cron 表達式定義複雜的排程規則。',
        ...
        SCOPE: {
            ...
            PREVIEW_TITLE: '靜音規則預覽',
            PREVIEW_DESCRIPTION: '根據目前設定預覽將被靜音的事件。',
            PREVIEW_EMPTY: '目前沒有符合條件的事件。',
        },
    },
    RESOURCE_LIST: {
        SEARCH_PLACEHOLDER: '搜索和篩選',
    ...
    AUTOMATION_PLAYBOOKS: {
        ...
        ERRORS: {
            ...
            SAVE_ERROR: '儲存腳本失敗。',
            DELETE_ERROR: '刪除腳本失敗。',
            BATCH_DELETE_ERROR: '批次刪除腳本失敗。',
            RUN_ERROR: '執行腳本失敗。',
            MISSING_COLUMNS: '欄位定義缺失',
        },
        TABLE_HEADERS: {
            NAME: '腳本名稱',
            TRIGGER: '觸發器',
