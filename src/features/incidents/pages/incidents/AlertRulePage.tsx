...
import { AlertRule, TableColumn, RuleAnalysisReport } from '@/shared/types';
import Icon from '@/shared/components/Icon';
import AlertRuleEditModal from '@/features/incidents/components/AlertRuleEditModal';
import UnifiedSearchModal, { AlertRuleFilters } from '@/shared/components/UnifiedSearchModal';
...
import RuleAnalysisModal from '@/features/incidents/components/RuleAnalysisModal';
...
const AlertRulePage: React.FC = () => {
    ...
    const handleCopyRule = (ruleToCopy: AlertRule) => {
        const { id, ...restOfRule } = ruleToCopy;
        const newRuleData = {
            ...restOfRule,
            name: `Copy of ${ruleToCopy.name}`,
            enabled: false,
        };
        setEditingRule(newRuleData as AlertRule);
        setIsEditModalOpen(true);
    };
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <UnifiedSearchModal
                ...
                onSearch={(newFilters) => {
                    setFilters(newFilters as AlertRuleFilters);
