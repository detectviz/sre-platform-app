...
import { NotificationChannel, NotificationChannelType, NotificationChannelFilters, TableColumn } from '@/shared/types';
import Icon from '@/shared/components/Icon';
import Toolbar, { ToolbarButton } from '@/shared/components/Toolbar';
import TableContainer from '@/shared/components/TableContainer';
import NotificationChannelEditModal from '@/features/settings/components/NotificationChannelEditModal';
...
const NotificationChannelPage: React.FC = () => {
    ...
    const { sortConfig, sortParams, handleSort } = useTableSorting({ defaultSortKey: 'last_tested_at', defaultSortDirection: 'desc' });
