...
import { Resource, Incident, MetricsData, IncidentSeverity } from '@/shared/types';
...
import { formatTimestamp, formatRelativeTime } from '@/shared/utils/time';
import { resolveResourceStatusPresentation } from '@/shared/utils/resource';
