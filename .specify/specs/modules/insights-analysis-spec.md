...
1. **Given** 我在「Insights Analysis」頁面, **When** 我選擇時間區間「2025-09-01 ~ 2025-09-07」並勾選「CPU、Memory」, **Then** 系統必須顯示兩條趨勢圖，並標示該時段的平均值與峰值。
